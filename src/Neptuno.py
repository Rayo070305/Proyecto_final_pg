...
def main():
    ...
    planet_texture_id = load_texture("opengl project/image/neptune.jpg")[0]
    info_texture_id, info_width, info_height = load_texture("opengl project/image/neptunoinfo.jpg")
    ...
    while True:
        ...
        glPushMatrix()
        glTranslatef(2.5, 0, 0)  # Mover el planeta a la derecha
        glRotatef(angle, 0, 1, 0)
        glBindTexture(GL_TEXTURE_2D, planet_texture_id)
        draw_sphere(2.8, 30, 30, planet_texture_id)
        glPopMatrix()
