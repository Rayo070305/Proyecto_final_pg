...
pygame.display.set_caption('Información sobre Marte')
...
image = pygame.image.load("opengl project/image/mars.jpg")
...
texts = ["",
    ...
    "Temperatura de la superficie: Varía entre -125°C y 20°C.",
    "Diámetro: Aproximadamente 6,779 kilómetros.",
    "Distancia a la Tierra: Varía entre 54.6 y 401 millones de kilómetros.",
    "Edad: Formado hace unos 4.5 mil millones de años.",
    "Masa: Aproximadamente 0.11 veces la masa de la Tierra.",
    "Vida útil: Como planeta, existirá mientras dure el sistema solar",
     " aproximadamente otros 5 mil millones de años.",
    "Curiosidad: Tiene el monte más alto y el cañón más profundo del sistema solar (Monte Olimpo y Valles Marineris)."
]
