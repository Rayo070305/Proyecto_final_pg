...
def main():
    ...
    planet_texture_id = load_texture("opengl project/image/sun.jpg")[0]
    info_texture_id, info_width, info_height = load_texture("opengl project/image/solinfo.jpg")
    ...
    while True:
        ...
        draw_sphere(4.0, 30, 30, planet_texture_id)
        glPopMatrix()
