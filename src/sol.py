...
image = pygame.image.load("opengl project/image/sun.jpg")
...
texts = ["",
    ...
    "Temperatura de la superficie: Aproximadamente 5,500 °C.",
    
    "Diámetro: Cerca de 1.4 millones de kilómetros.",
    
    "Distancia a la Tierra: Alrededor de 150 millones de kilómetros.",
    
    "Edad: Aproximadamente 4.6 mil millones de años.",
    
    "Masa: Un poco más de 300,000 veces la masa de la Tierra.",
    
    "Vida útil: Se espera que dure otros 5 mil millones de años.",
    
    "Curiosidad: El sol es una estrella enana amarilla."
]
