...
def main():
    ...
    planet_texture_id = load_texture("opengl project/image/uranus.jpg")[0]
    info_texture_id, info_width, info_height = load_texture("opengl project/image/uranoinfo.jpg")
    ...
    while True:
        ...
        draw_sphere(3.3, 30, 30, planet_texture_id)
        glPopMatrix()
