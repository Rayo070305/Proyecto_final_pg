...
def main():
    ...
    planet_texture_id = load_texture("opengl project/image/earth.jpg")[0]
    info_texture_id, info_width, info_height = load_texture("opengl project/image/tierrainfo.jpg")
